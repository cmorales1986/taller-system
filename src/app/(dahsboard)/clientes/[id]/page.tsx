          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Cliente desde{" "}
                {new Date(cliente.creado_en).toLocaleDateString("es-PY", {
                  month: "long",
                  year: "numeric",
                })}
              </p>
              ...
              >
                ...
                <div>
                  ...
                  <input
                    value={form.ruc_ci}
                    onChange={(e) =>
                      setForm({ ...form, ruc_ci: e.target.value })
                    }
                    className={inputClass}
                  />
                </div>
        ...
        <Card>
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between">
              ...
              <Link
                href={`/vehiculos?cliente_id=${cliente.id}`}
              ...
              {ordenes.map((o, i) => (
                <div key={o.id}>
                  <div className="flex items-center justify-between py-3">
                    ...
                    <div className="flex items-center gap-4">
                      <span
                        className={`text-xs font-semibold px-2.5 py-1 rounded-full border ${ESTADOS[o.estado]?.color}`}
                      >
